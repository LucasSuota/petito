      ...
      <div className="max-w-screen-lg mx-auto py-4 px-8 flex flex-row items-center justify-between">
        ...
        <div>
          <ul className="flex flex-row items-center justify-end sm:gap-10 gap-4">
            <Link href={"/login"}>
              <li className="bg-primaryblue px-4 py-2 sm:px-6 sm:py-4 rounded-sm hover:bg-primarypurple active:bg-primaryblack text-white cursor-pointer transition-all">
                Entrar
              </li>
            </Link>
          </ul>
